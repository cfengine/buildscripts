...
| [libcurl](http://curl.haxx.se/download.html)                                     | 7.75.0 | 7.79.1 | 7.79.1 | 7.79.1 |                          |
...
| [OpenLDAP](http://www.openldap.org/software/download/OpenLDAP/openldap-release/) | 2.4.58 | 2.4.58 | 2.6.0  | 2.6.0  | Enterprise agent only    |
| [OpenSSL](http://openssl.org/)                                                   | 1.1.1k | 1.1.1l | 1.1.1l | 1.1.1l |                          |
| [PCRE](http://ftp.csx.cam.ac.uk/pub/software/programming/pcre/)                  | 8.44   | 8.45   | 8.45   | 8.45   |                          |
...
| CFEngine version                                    | 3.12.x | 3.15.x | 3.18.x | master |
| --------------------------------------------------- | ------ | ------ | ------ | ------ |
| [Apache](http://httpd.apache.org/)                  | 2.4.47 | 2.4.51 | 2.4.51 | 2.4.51 |
| [APR](https://apr.apache.org/)                      | 1.7.0  | 1.7.0  | 1.7.0  | 1.7.0  |
| [apr-util](https://apr.apache.org/)                 | 1.6.1  | 1.6.1  | 1.6.1  | 1.6.1  |
| [Git](https://www.kernel.org/pub/software/scm/git/) | 2.31.1 | 2.33.1 | 2.33.1 | 2.33.1 |
| [PHP](http://php.net/)                              | 7.2.34 | 7.4.25 | 8.0.12 | 8.0.12 |
| [PostgreSQL](http://www.postgresql.org/)            | 10.17  | 12.8   | 13.4   | 13.4   |
