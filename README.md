...
| [libiconv](http://ftp.gnu.org/gnu/libiconv/)                                     | 1.17   | 1.17   | 1.16   | Needed by libxml2        |
...
| [OpenLDAP](http://www.openldap.org/software/download/OpenLDAP/openldap-release/) | 2.4.58 | 2.6.3  | 2.6.0  | Enterprise agent only    |
...
| CFEngine version                                    | 3.15.x | 3.18.x | master |
| --------------------------------------------------- | ------ | ------ | ------ |
| [Apache](http://httpd.apache.org/)                  | 2.4.54 | 2.4.54 | 2.4.51 |
| [APR](https://apr.apache.org/)                      | 1.7.0  | 1.7.0  | 1.7.0  |
| [apr-util](https://apr.apache.org/)                 | 1.6.1  | 1.6.1  | 1.6.1  |
| [Git](https://www.kernel.org/pub/software/scm/git/) | 2.38.1 | 2.38.1 | 2.34.1 |
| [PHP](http://php.net/)                              | 7.4.32 | 8.0.24 | 8.1.0  |
| [PostgreSQL](http://www.postgresql.org/)            | 12.12  | 13.8   | 13.5   |
| [rsync](https://download.samba.org/pub/rsync/)      | 3.2.7  | 3.2.7  | 3.2.3  |
