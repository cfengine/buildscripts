...
| [libiconv](https://ftp.gnu.org/gnu/libiconv/)                                     | 1.18   | 1.19   | 1.19   | Needed by libxml2        |
| [libxml2](https://gitlab.gnome.org/GNOME/libxml2)                                 | 2.15.1 | 2.15.2 | 2.15.2 |                          |
| [libyaml](https://pyyaml.org/wiki/LibYAML)                                        | 0.2.5  | 0.2.5  | 0.2.5  |                          |
| [LMDB](https://github.com/LMDB/lmdb/)                                             | 0.9.33 | 0.9.35 | 0.9.35 |                          |
| [OpenLDAP](https://www.openldap.org/software/download/OpenLDAP/openldap-release/) | 2.6.10 | 2.6.13 | 2.6.13 | Enterprise agent only    |
| [OpenSSL](https://openssl.org/)                                                   | 3.0.18 | 3.6.1  | 3.6.1  | See **note** below       |
...
| [zlib](https://www.zlib.net/)                                                     | 1.3.1  | 1.3.2  | 1.3.2  |                          |
...
| [Git](https://www.kernel.org/pub/software/scm/git/) | 2.52.0 | 2.53.0 | 2.53.0 |
| [libexpat](https://libexpat.github.io/)             | -      | 2.7.5  | 2.7.5  |
| [PHP](https://php.net/)                             | 8.3.28 | 8.3.30 | 8.5.4  |
| [PostgreSQL](https://www.postgresql.org/)           | 15.15  | 16.13  | 18.3   |
