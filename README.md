...
| [libcurl](https://curl.se/download.html)                                          | 8.15.0 | 8.14.1 | 8.15.0 |                          |
...
| [libxml2](https://gitlab.gnome.org/GNOME/libxml2)                                 | 2.14.5 | 2.14.4 | 2.14.5 |                          |
...
| [OpenSSL](https://openssl.org/)                                                   | 3.0.17 | 3.5.0  | 3.5.1  |                          |
...
| :-------------------------------------------------- | :----- | :----- | :----- |
| [Apache](https://httpd.apache.org/)                 | 2.4.64 | 2.4.63 | 2.4.64 |
| [APR](https://apr.apache.org/)                      | 1.7.6  | 1.7.6  | 1.7.6  |
| [apr-util](https://apr.apache.org/)                 | 1.6.3  | 1.6.3  | 1.6.3  |
| [Git](https://www.kernel.org/pub/software/scm/git/) | 2.50.1 | 2.50.0 | 2.50.1 |
| [libexpat](https://libexpat.github.io/)             | -      | 2.7.1  | 2.7.1  |
| [PHP](https://php.net/)                             | 8.3.23 | 8.3.22 | 8.4.10 |
