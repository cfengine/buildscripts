...
Version: %{version}
Release: 1
Source0: postgresql-9.5.5.tar.gz
...
%{prefix}/lib/libecpg_compat.so.3.7
%{prefix}/lib/libecpg.so
%{prefix}/lib/libecpg.so.6
%{prefix}/lib/libecpg.so.6.7
%{prefix}/lib/libpgtypes.so.3
%{prefix}/lib/libpgtypes.so.3.6
%{prefix}/lib/libpq.so.5
%{prefix}/lib/libpq.so.5.8
...
%{prefix}/share/postgresql/extension/btree_gist--1.0--1.1.sql
%{prefix}/share/postgresql/extension/btree_gist--1.1.sql
...
%{prefix}/share/postgresql/extension/hstore--1.2--1.3.sql
%{prefix}/share/postgresql/extension/hstore--1.3.sql
...
%{prefix}/share/postgresql/extension/pageinspect--1.1--1.2.sql
%{prefix}/share/postgresql/extension/pageinspect--1.2--1.3.sql
%{prefix}/share/postgresql/extension/pageinspect--1.3.sql
%{prefix}/share/postgresql/extension/pageinspect--unpackaged--1.0.sql
%{prefix}/share/postgresql/extension/pageinspect.control
%{prefix}/share/postgresql/extension/pg_buffercache--1.0--1.1.sql
%{prefix}/share/postgresql/extension/pg_buffercache--1.1.sql
...
%{prefix}/share/postgresql/extension/pg_prewarm--1.0.sql
%{prefix}/share/postgresql/extension/pg_prewarm.control
%{prefix}/share/postgresql/extension/pg_stat_statements--1.0--1.1.sql
%{prefix}/share/postgresql/extension/pg_stat_statements--1.1--1.2.sql
%{prefix}/share/postgresql/extension/pg_stat_statements--1.2--1.3.sql
%{prefix}/share/postgresql/extension/pg_stat_statements--1.3.sql
...
%{prefix}/share/postgresql/extension/pgcrypto--1.0--1.1.sql
%{prefix}/share/postgresql/extension/pgcrypto--1.1--1.2.sql
%{prefix}/share/postgresql/extension/pgcrypto--1.2.sql
...
%{prefix}/share/postgresql/extension/pgstattuple--1.1--1.2.sql
%{prefix}/share/postgresql/extension/pgstattuple--1.2--1.3.sql
%{prefix}/share/postgresql/extension/pgstattuple--1.3.sql
...
%{prefix}/share/postgresql/extension/tsm_system_rows--1.0.sql
%{prefix}/share/postgresql/extension/tsm_system_rows.control
%{prefix}/share/postgresql/extension/tsm_system_time--1.0.sql
%{prefix}/share/postgresql/extension/tsm_system_time.control
