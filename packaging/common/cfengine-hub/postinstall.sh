...
# changed permissions and onwer of PHP and JS dependencies
...
chmod 0440 -R $PREFIX/httpd/htdocs/vendor
chmod 0440 -R $PREFIX/httpd/htdocs/public/scripts/node_modules
